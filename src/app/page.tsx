...
function ProductCatalog({ activeCategory, onCategoryChange, onQuickView }: ProductCatalogProps) {
...
function ProductCatalogFromUrl({ onQuickView }: Pick<ProductCatalogProps, "onQuickView">) {
...
export default function Home() {
  ...
  return (
    <div className="bg-bone text-ink">
      ...
      >
        <ProductCatalogFromUrl onQuickView={setSelectedProduct} />
      </Suspense>
